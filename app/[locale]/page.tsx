          ...
          <div className="relative w-full lg:w-[60%] xl:w-[58%] mt-6 sm:mt-8 lg:mt-0 flex flex-col items-center lg:items-end">
            ...
            <div className="w-full max-w-md mb-4 flex justify-start">
              <div className="flex items-center gap-3">
                ...
                />
                <span className="text-base font-medium" style={{ color: '#002903' }}>{t('hero.freeCredits')}</span>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                <div className="relative z-10 mt-32 sm:mt-40 lg:mt-48">
                  <h3 className="text-base sm:text-lg font-semibold mb-2 text-center" style={{ color: '#002903' }}>{t('upload.title')}</h3>
                  ...
                  <p className="text-xs text-center mt-2" style={{ color: '#002903' }}>{t('upload.supportedFormats')}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 border-2 border-gray-200">
              ...
              <h3 className="text-base sm:text-lg font-semibold mb-3" style={{ color: '#002903' }}>
                {t('bento.smartExcel.title')}
              </h3>
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                {t('bento.smartExcel.description')}
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 border-2 border-gray-200 md:col-span-2">
              ...
              <h3 className="text-base sm:text-lg font-semibold mb-3" style={{ color: '#002903' }}>
                {t('bento.slideReady.title')}
              </h3>
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                {t('bento.slideReady.description')}
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 border-2 border-gray-200 md:col-span-2">
              <h3 className="text-base sm:text-lg font-semibold mb-3" style={{ color: '#002903' }}>
                {t('bento.interactiveCharts.title')}
              </h3>
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed mb-6">
                {t('bento.interactiveCharts.description')}
              </p>
            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 border-2 border-gray-200">
              ...
              <h3 className="text-base sm:text-lg font-semibold mb-3" style={{ color: '#002903' }}>
                {t('bento.editPowerpoint.title')}
              </h3>
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                {t('bento.editPowerpoint.description')}
              </p>
            </div>
        ...
        <footer className="w-full border-t border-gray-200 bg-white mt-16 sm:mt-20 md:mt-24">
          <div className="max-w-6xl 2xl:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
              ...
              {/* Menu Section */}
              <div>
                <h3 className="text-sm font-semibold mb-4" style={{ color: '#002903' }}>{t('footer.menu')}</h3>
              ...
              {/* Policies Section */}
              <div>
                <h3 className="text-sm font-semibold mb-4" style={{ color: '#002903' }}>{t('footer.policies')}</h3>
                <ul className="space-y-2">
                  <li>
