...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/basic-plan.png?v=2", sizes: "any" },
      { url: "/basic-plan.png?v=2", sizes: "32x32", type: "image/png" },
      { url: "/basic-plan.png?v=2", sizes: "16x16", type: "image/png" },
    ],
    apple: "/basic-plan.png?v=2",
  },
};
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="icon" type="image/png" href="/basic-plan.png?v=2" />
        <link rel="shortcut icon" type="image/png" href="/basic-plan.png?v=2" />
