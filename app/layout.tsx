  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="icon" href="/basic-plan.png?v=2024" type="image/png" />
        <link rel="shortcut icon" href="/basic-plan.png?v=2024" type="image/png" />
        <link rel="apple-touch-icon" href="/basic-plan.png?v=2024" />
