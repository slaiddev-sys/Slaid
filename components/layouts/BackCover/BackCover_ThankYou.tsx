...
export interface BackCoverThankYouProps {
  /**
 ...
 */
export default function BackCover_ThankYou({
  title = 'Thank you',
  ...
  const containerClasses = `back-cover-thank-you relative ${className}`;
                ...
                >
                  <FigmaText
                    ...
                    onShowPopup={(position: { x: number; y: number }, fontSize: number, fontFamily: string) => {
                      const titleElement = document.querySelector('.back-cover-thank-you .title-layer');
                      if (titleElement) {
                        const titleRect = titleElement.getBoundingClientRect();
                        const canvasContainer = titleElement.closest('.back-cover-thank-you') as HTMLElement;
                        if (canvasContainer) {
                  ...
                  {currentEmail && (
                    <div className="email-layer pointer-events-auto" style={{ position: 'relative', zIndex: 10 }}>
                      <FigmaText
                        ...
                        align={contactAlignmentState as 'left' | 'center' | 'right' | 'justify'}
                        ...
                        style={{
                          ...
                          color: currentContactColor,
                          textAlign: contactAlignmentState as 'left' | 'center' | 'right',
                          wordWrap: 'break-word',
                          overflowWrap: 'break-word',
                          whiteSpace: 'normal'
                        }}
                        ...
                        onShowPopup={(position: { x: number; y: number }, fontSize: number, fontFamily: string) => {
                          const emailElement = document.querySelector('.back-cover-thank-you .email-layer');
                          if (emailElement) {
                            const emailRect = emailElement.getBoundingClientRect();
                            const canvasContainer = emailElement.closest('.back-cover-thank-you') as HTMLElement;
                            if (canvasContainer) {
                              const canvasRect = canvasContainer.getBoundingClientRect();
                  ...
                  {currentSocial && (
                    <div className="social-layer pointer-events-auto" style={{ position: 'relative', zIndex: 10 }}>
                      <FigmaText
                        ...
                        onShowPopup={(position: { x: number; y: number }, fontSize: number, fontFamily: string) => {
                          const socialElement = document.querySelector('.back-cover-thank-you .social-layer');
                          if (socialElement) {
                            const socialRect = socialElement.getBoundingClientRect();
                            const canvasContainer = socialElement.closest('.back-cover-thank-you') as HTMLElement;
                            if (canvasContainer) {
                              const canvasRect = canvasContainer.getBoundingClientRect();
                  ...
                  {currentPhone && (
                    <div className="phone-layer pointer-events-auto" style={{ position: 'relative', zIndex: 10 }}>
                      <FigmaText
                        ...
                        onShowPopup={(position: { x: number; y: number }, fontSize: number, fontFamily: string) => {
                          const phoneElement = document.querySelector('.back-cover-thank-you .phone-layer');
                          if (phoneElement) {
                            const phoneRect = phoneElement.getBoundingClientRect();
                            const canvasContainer = phoneElement.closest('.back-cover-thank-you') as HTMLElement;
                            if (canvasContainer) {
                              const canvasRect = canvasContainer.getBoundingClientRect();
                   ...
                   {currentPhone2 && (
                     <div className="phone2-layer pointer-events-auto" style={{ position: 'relative', zIndex: 10, marginTop: '8px' }}>
                       <FigmaText
                         ...
                         onShowPopup={(position: { x: number; y: number }, fontSize: number, fontFamily: string) => {
                           const phone2Element = document.querySelector('.back-cover-thank-you .phone2-layer');
                           if (phone2Element) {
                             const phone2Rect = phone2Element.getBoundingClientRect();
                             const canvasContainer = phone2Element.closest('.back-cover-thank-you') as HTMLElement;
                             if (canvasContainer) {
                               const canvasRect = canvasContainer.getBoundingClientRect();
                   ...
                   {(currentCity || currentCountry) && (
                     <div className="location-layer pointer-events-auto" style={{ position: 'relative', zIndex: 10 }}>
                       <FigmaText
                         ...
                         onShowPopup={(position: { x: number; y: number }, fontSize: number, fontFamily: string) => {
                           const locationElement = document.querySelector('.back-cover-thank-you .location-layer');
                           if (locationElement) {
                             const locationRect = locationElement.getBoundingClientRect();
                             const canvasContainer = locationElement.closest('.back-cover-thank-you') as HTMLElement;
                             if (canvasContainer) {
                               const canvasRect = canvasContainer.getBoundingClientRect();
                   ...
                   {currentWebsite && (
                     <div className="website-layer pointer-events-auto" style={{ position: 'relative', zIndex: 10 }}>
                       <FigmaText
                         ...
                         onShowPopup={(position: { x: number; y: number }, fontSize: number, fontFamily: string) => {
                           const websiteElement = document.querySelector('.back-cover-thank-you .website-layer');
                           if (websiteElement) {
                             const websiteRect = websiteElement.getBoundingClientRect();
                             const canvasContainer = websiteElement.closest('.back-cover-thank-you') as HTMLElement;
                             if (canvasContainer) {
                               const canvasRect = canvasContainer.getBoundingClientRect();
