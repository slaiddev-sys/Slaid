...
export default function PolarCheckout({ 
  ...
  if (!polarConfig.publicAccessToken || !productId) {
    return (
      <button 
        className={`w-full h-[40px] rounded-[6.75px] border border-[#4a5565] flex items-center justify-center text-[13px] leading-[17.5px] font-normal transition ${className}`}
